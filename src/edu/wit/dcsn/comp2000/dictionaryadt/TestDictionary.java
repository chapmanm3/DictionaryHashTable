...
/**
 * A Dictionary implementation using an array of LinkedLists as the backing
 * store.
 * 
...
public class TestDictionary
	 ...
	 * 
	 * @param args -unused-
	 * @throws FileNotFoundException if the metrics log can't be created
	 */
	public static void main( String[] args ) throws FileNotFoundException
		...
		DictionaryInterface< String, Integer > testDictionary = 
										new Dictionary<>( 3 ) ;
		...
		testDictionary =			new Dictionary<>( 123, 2.0F, true ) ;
		...
		// re-instantiate the Dictionary with other settings
		testDictionary =			new Dictionary<>( 8, 4.0F, false ) ;
		...
		// print it
		testPrintDictionary( testDictionary ) ;
		...
		// re-instantiate the Dictionary with other settings
		testDictionary =			new Dictionary<>( 8, 0.01F, true ) ;
	...
	/**
	 * Unit test utility:<br>
	 * Iterate over both the keys and values ensuring they return the same values.
	 */
	...
	/**
	 * Unit test utility:<br>
	 * Load a Dictionary with test data. Also exercises both iterators and remove()
	 * functionality.
	 * 
	 * @param testDictionary
	 *        the Dictionary used for the current test
	 */
	private static void testLoadDictionary( DictionaryInterface<String,
	                                                            Integer> testDictionary )
    	{
    	System.out.println( "\nLoading dictionary:\n" ) ;
		...
		// make the load factor threshold smaller - may force the table to
		// resize immediately
...
//    						" returned " + testDictionary.remove( "Iterator" ) ) ;
	 ...
	 */
	private static void testPrintDictionary( DictionaryInterface<String,
                                             Integer> testDictionary )
    	{
    	System.out.println( "\nPrinting dictionary:\n" ) ;
		...
		System.out.println( "\nFinished printing dictionary\n" ) ;
        	
    	}	// end testPrintDictionary()
	
	}	// end class DictionaryLinkedList
